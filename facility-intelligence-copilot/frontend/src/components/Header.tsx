      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          {isTechnician ? (
            <Link
              to="/profile"
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] text-[var(--text-muted)] transition-all hover:border-[#5C3E94] hover:text-[#5C3E94] active:scale-95"
            ...
            <Link
              to="/admin"
              className="flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] text-[var(--text-muted)] transition-all hover:border-[#F25912] hover:text-[#F25912] active:scale-95"
              title="Admin Console"
            >
              <Shield size={16} />
            </Link>
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] px-2.5 py-1.5 text-xs font-semibold text-[var(--text-muted)] transition-all hover:border-red-500/40 hover:bg-red-500/10 hover:text-red-400 active:scale-95"
